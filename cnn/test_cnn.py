...
def main():
	...
	t0 = datetime.now()
	model.fit(Xtrain, Ytrain, epochs=5, batch_sz=500, learning_rate=10e-6, decay=0.99, momentum=0.9, reg_l2=0.01, debug=True, cal_train=False, debug_points=100, valid_set=[Xtest[:1000], Ytest[:1000]])
