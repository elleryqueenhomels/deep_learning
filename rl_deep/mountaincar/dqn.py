...
class Brain:
    ...
    def __init__(self, input_sz, output_sz, hidden_layer_sizes, gamma, learning_rate=LEARNING_RATE):
    ...
    def optimize(self, batch_states, batch_actions, batch_rewards, batch_next_states, batch_dones):
...
class Agent:
    ...
    def __init__(self, brain, num_actions, batch_sz, memory_capacity, eps_start, eps_end, eps_steps):
        self.brain = brain
    ...
    def train(self, state, action, reward, next_state, done):
        ...
        if self.memory.current_length() > self.batch_sz:
            ...
            self.brain.optimize(batch_states, batch_actions, batch_rewards, batch_next_states, batch_dones)
...
if __name__ == '__main__':
    ...
    brain = Brain(num_state, num_actions, HIDDEN_LAYER_SIZES, GAMMA, learning_rate=LEARNING_RATE)
    
    agent = Agent(brain, num_actions, BATCH_SZ, MEMORY_CAPACITY, eps_start=EPS_START, eps_end=EPS_STOP, eps_steps=EPS_STEPS)
