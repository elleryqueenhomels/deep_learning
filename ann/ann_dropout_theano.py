...
class ANN(object):
	...
	def fit(self, X, Y, epochs=10000, batch_size=0, learning_rate=10e-6, decay=0, momentum=0, eps=10e-10, debug=False, cal_train=False, debug_points=100, valid_set=None):
