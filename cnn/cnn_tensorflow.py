...
class CNN(object):
	...
	def fit(self, X, Y, epochs=1000, batch_sz=0, learning_rate=10e-6, decay=0, momentum=0, reg_l2=0, debug=False, cal_train=False, debug_points=100, valid_set=None):
		...
		self.tfX = tf.placeholder(tf.float32, shape=(None, width, height, c), name='X')
