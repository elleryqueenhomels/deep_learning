# Use TensorFlow to re-implement the SGDRegressor
...
class SGDRegressor:
	def __init__(self, D, learning_rate=0.1):
		print('Use TensorFlow to implement SGDRegressor')
		lr = learning_rate

		# create inputs, targets, params
		# matmul doesn't like when w is 1-D
		# so we make it 2-D then flatten the prediction
